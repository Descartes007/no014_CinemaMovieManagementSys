  ...
  <div class="main">
    <div class="item2" v-for="(item, index) in leavingMessageList" :key="index">
      <div style="display: flex">
        <img class="av2" v-if="item.user" :src="item.user.avatar" alt="null">
        <img class="av2" v-else src="https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png" alt="null">
        <div>
